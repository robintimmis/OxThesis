...
Efficiency
Magnification
Total energy per Joule
Result in context, add lasers plot here.

Flying focus


Magnification = 20.072674842184274
M SP2 = 1022.6686243613655


Due to harmonic source size shrinkage and the roll-off, the efficiency of the SP1 beamline is very low.


Note that that this dramatic magnification at focus is not unrealistic and is indeed consistent with the literature. Vicenti et al 2019 demonstrated a 3 order of magnitude gain of 1000 for a 3 PW 20 fs system. The longer duration of the pulse here leads to greater hole boring and therefore a correspondingly larger magnification factor.
Note that the factor derived here is for spatial magnification only, it does not account for the additional temporal compression, however the 1D PIC simulations suggest that for this regime (ie ROM) we do not get extra intensity from this (Leontovich boundary conditions).
Calculate the corresponding peak intensity.

Stick to SP2 beamline.

0.102 microJ per harmonic - 0.044 + 0.1733

The SP1 beamline efficiency is lower due to the roll-off and the harmonic source size shrinkage

Efficiency 
2.043661294970399e-10
plus 3.466922061995753e-10
minus 8.627647263599505e-11

Magnification = 1774.6373284921292
Magnification = 1039.2824774016885
Magnification = 746.5830067717158


Spot size from data is 
wl = 4.669182775447931e-06
wLow = 5.331391232110277e-06
w high = 3.718791008941786e-06



Conservative estimate of power of focused beam since 1000 predictd for ORION paramaters. And there is also the temporal compression in the CSE regime due to the non-satisfactoion of Leontovich

Also note that on the plot this is power averaged over the full pulse. The X-ray peak power, will be more like that power divided by the number of laser pulse cycles and then divide by the attosecond duration. Wowza.
