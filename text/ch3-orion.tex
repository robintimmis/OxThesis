...
\end{figure}
Experimental data points are consistent within their errors with one another, the theory and the simulation, however, large uncertainty remains with such a low shot number. It is notable that the SP2 beamline on average almost 6 times brighter than the SP1 beamline despite having over twice the energy content while the single beamlet shot is over 7 times weaker in intensity compared to the mean intensity of the full SP2 beamline. These scaling are consistent with HHG theory and not bremmstrahlung lending credibility to these results.
