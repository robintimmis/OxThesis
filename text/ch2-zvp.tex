...
\begin{figure}
	\centering
	\includegraphics[width=0.7\linewidth]{"../../../Library/Mobile Documents/com~apple~CloudDocs/Documents/Oxford/DPhil/Sims/Smilei/3D/plots_ZVP_confirmation/zvp_hhg_beam_fourier"}
...
\textbf{**To do: these dynamics plots need fixing. Should add the times, also e and f have distance instead of time on y axis, also need to convert from timstep to time. D) needs teh scale changing. also the x axis needs converting to distance.**}
