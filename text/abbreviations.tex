...
\begin{mclistof}{List of Symbols and Abbreviations}{3.2cm}
...
\begin{acronym}
	...
	\acro{AR}{Anti-Reflective}
	\acro{ARP}{Apparent Reflection Point}
	\acro{BBXRD}{BroadBand X-Ray Diffraction}
	...
	\acro{CWE}{Coherent Wake Emission}
	\acro{DPM}{Double Plasma Mirror}
	...
	\acro{OMM}{Oscillating Mirror Model}
	\acro{PIC}{Particle-In-Cell}
	\acro{PM}{Plasma Mirror}
	\acro{QED}{Quantum Electro-Dynamics}
	\acro{ROM}{Relativistic Oscillating Mirror}
	\acro{RPM}{Relativistic Plasma Mirror}
	\acro{RR}{Radiation Reaction}
	\acro{SHHG}{Surface High Harmonic Generation}
	\acro{SF-QED}{Strong-Field Quantum Electro-Dynamics}
	\acro{TCC}{Target Chamber Centre}
	\acro{VLA}{Vacuum Laser Acceleration}
	\acro{XHHG}{X-ray High Harmonic Generation}
