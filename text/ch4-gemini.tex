...
% TODO compare these results to the sims: currently sims predict 50 times lower intensity, comment that at least for the KAP crystal we have room to apodise and reduce beam divergence and increase signal so we should get this at least
